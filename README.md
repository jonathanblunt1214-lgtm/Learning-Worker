...
The workflow has a concurrency lock and a 20-minute job timeout. Its token can update only this private worker repository's encrypted release-state asset. It cannot write to The Crucible.
